...
public class Deposit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 171, 52));
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 171, 52));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 171, 52));
        ...
        jTextField1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Deposit Amount", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
        ...
        jPanel3.add(charge, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, 340, 30));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        double add = Float.parseFloat(jTextField1.getText());
        ...
        try {
            ...
            while (rs.next()) {
                ...
                double addbal = add + oldbal;
                double charges = 15.0;
                double nonMember = addbal + 15.00;

                if (Bname.equals("3JL")) {
                    int magadd = JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to deposit now? ");
                    if (magadd == 0) {
                        try {
                    ...
                    if (magadd == 0) {
                        try {
                            ...
                            if (st.executeUpdate() != 0) {
                                JOptionPane.showMessageDialog(null, "Successfully Deposited with charges");
                                DisplayData();
                                jTextField1.setText("");
                    ...
                    System.out.println("Deposited: " + oldbal );
                    System.out.println("Additioinal Charges: " + charges );
                    System.out.println("--------------------" );
                    System.out.println("Total: " + nonMember);
                }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        String pin = JOptionPane.showInputDialog(rootPane, "Input your PIN:");

...
public class Transfer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 171, 52));
        ...
        jPanel3.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, 280, 60));
        ...
        jPanel3.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 280, 60));

        jTextField1.setBackground(new java.awt.Color(204, 204, 204));
        jTextField1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(0, 0, 153));
        jTextField1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Amount", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        jPanel3.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, 280, 60));
        ...
        jPanel3.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 180, 280, 60));
        ...
        jTextField2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Target Account", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
        jTextField2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField2ActionPerformed(evt);
            }
        });
        jPanel3.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 280, 60));
         ...
         try{
            ...
            while (rs.next()) {
                String Bname = rs.getString("BankName");
                 if (Bname.equals("3JL")) {
                     try {
                         String faccno = jLabel16.getText();
                         String taccno = jTextField2.getText();
//            double balance= Float.parseFloat( jLabel17.getText( ));
                         double amount = Float.parseFloat(jTextField1.getText());
//                         int log = Integer.parseInt(Login.acclog.getText());

                         String query2 = "update users  set Balance = Balance - '" + amount + "' where AccNumber = '" + faccno + "'";
                         PreparedStatement st2 = myConnection.getConnection().prepareStatement(query2);
                         int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to continue? ", "Attention ", JOptionPane.YES_NO_OPTION);
//                         int dialogResult = JOptionPane.showConfirmDialog(null, "This transaction has 15.00 fee,\n Do you still want to continue? ", "Attention ", JOptionPane.YES_NO_OPTION);
                        
                         String query3 = "update users  set Balance = Balance + '" + amount + "' where AccNumber = '" + taccno + "'";
...
//            double balance= Float.parseFloat( jLabel17.getText( ));
                        double amount = Float.parseFloat(jTextField1.getText());
//                         int log = Integer.parseInt(Login.acclog.getText());
                        double ch = amount + 15.00;   

                         String query2 = "update users  set Balance = Balance - '" + ch + "' where AccNumber = '" + faccno + "'";
                         PreparedStatement st2 = myConnection.getConnection().prepareStatement(query2);
//                         int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to continue? ", "Attention ", JOptionPane.YES_NO_OPTION);
                         int dialogResult = JOptionPane.showConfirmDialog(null, "This transaction has 15.00 fee,\n Do you still want to continue? ", "Attention ", JOptionPane.YES_NO_OPTION);
                         ...
                         if (dialogResult == JOptionPane.YES_OPTION) {
                             ...
                             st.executeUpdate();
                             st2.executeUpdate();
                             System.out.println("15.00 is deducted as for additional charges");
                             JOptionPane.showMessageDialog(null, "Your Balance has been updated");
                             DisplayData();
